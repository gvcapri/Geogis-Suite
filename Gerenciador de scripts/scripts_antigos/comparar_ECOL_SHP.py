...
# Carrega os arquivos
df1 = pd.read_excel(r"ecol_novotempo.xlsx")  #<- Aqui vai ECOLETA
df2 = pd.read_excel(r"shp_novotempo.xlsx")     #<- Aqui vai SHP
nome = "novo tempo - SHP_ECOLETA -  Comparativo.xlsx"
