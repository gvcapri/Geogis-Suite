...
arquivo_metrica = r"met_ouroverde.xlsx"
arquivo_shp = r"shp_ouroverde.xlsx"
nome_saida = "ouro verde - SHP_METRICA - Comparativo.xlsx"
...
print(f"Planilha gerada: {nome_saida}")
