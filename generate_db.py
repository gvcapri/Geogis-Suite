...
conn_path = os.path.join(root_dir, "src", "database", "connection.py")
base_path = os.path.join(root_dir, "src", "database", "models", "base.py")
entities_path = os.path.join(root_dir, "src", "database", "models", "entities.py")
...
conn_content = """from sqlalchemy import create_engine
from sqlalchemy.orm import sessionmaker

DATABASE_URL = "sqlite:///geogis.db"
...
entities_content = """from sqlalchemy import Column, Integer, String, ForeignKey, DateTime, Boolean, Text
